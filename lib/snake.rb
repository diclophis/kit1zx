...
#    end
    ...
    if gl.global_state["globalPlayerLocation"]
      ...
      #last_player_position[0] = gl.global_state["lastGlobalPlayerLocation"]["X"]
      #last_player_position[2] = gl.global_state["lastGlobalPlayerLocation"]["Y"]
      #if move_vector == nil
      #  move_vector = [player_position[0] - last_player_position[0], player_position[2] - last_player_position[2]]
      #end

      player_txt = "#{gl.global_counter.to_s} #{player_position} #{move_vector.inspect}"
    end
    ...
    if player_position
      ...
      case camera_index
        ...
        when 1
          ...
          #gl.lookat(1, ((camera_current_target[0] / 10.0) * 10), 1.0, camera_current_target[2]-15.0, pla, 10.0, 10.0, 33.0)
          gl.lookat(1, 20.0, 10.0, 20.0, 5.0, -1.0, 5.0, 33.0) 
